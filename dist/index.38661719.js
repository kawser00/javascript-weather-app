...
_uiDefault.default.init();

},{"./ui":"4ic4g","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"4ic4g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const UI = {
    ...
    async getAndPopulateUI () {
        ...
        const { city , country  } = _storageDefault.default.getData();
        //setting to weatherData and calling API
        _weatherDefault.default.city = city;
        _weatherDefault.default.country = country;
        //calling API
        const data = await _weatherDefault.default.getData();
        //populate UI
        console.log(this);
        if (data) this.populateUI(data);
    },
    populateUI (data) {
        const { cityInfoElm , iconElm , temperatureElm , pressureElm , humidityElm , feelElm ,  } = this.loadSelector();
        // console.log(data);
    ...
    init () {
        ...
        formElm.addEventListener("submit", async (e)=>{
            ...
            if (isValidated) {
                ...
                _storageDefault.default.city = city;
                _storageDefault.default.country = country;
                //saving to local storage
                _storageDefault.default.saveData();
...
},{"./storage":"fay3b","./weather":"fawjF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"fay3b":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//local storage data
const storage = {
...
},{}],"fawjF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _ui = require("./ui");
var _uiDefault = parcelHelpers.interopDefault(_ui);
...
const weatherData = {
    ...
    async getData () {
        ...
        try {
            const res = await fetch(`${this.BASE_URL}?q=${this.city},${this.country}&units=metric&appid=${this.API_ID}`);
            const data = await res.json();
            if (data.cod >= 400) {
                //error
                _uiDefault.default.showMessage(data.message);
                return false;
            } else return data;
        } catch (err) {
            _uiDefault.default.showMessage("Problem in fetching weather");
        }
    }
};
exports.default = weatherData;

},{"./ui":"4ic4g","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["5UGAA","7BQdY"], "7BQdY", "parcelRequirebbde")
